...
function checkScroll () {
  const a = document.querySelector('.animationHolder')
  console.log("winY " + (window.scrollY))
  // const aH = a.scrollHeight
  console.log("scrollTop " + a.scrollTop)
  // const howFar = (window.scrollY + window.innerHeight) - aH
  // let b = ((howFar / 2) / 100 * 5)
  // console.log(b)
  // const c = a.querySelector('.blur img')
  // const b = a.currentStyle.backgroundImage
  // console.log(window.getComputedStyle(a).getPropertyValue('background-image'))
  // if (b > 0) {
  //   c.style.filter = `blur(${b}px)`
  // }

  // how far into wipeholder i've scrolled
  // make that the blur number
}
